package com.anonymouscorgi.karakoram.jiuzhang.c1;

public class M200LongestPalindromicSubstring {
	...
	public static void main(String[] args) {
		...
		M200LongestPalindromicSubstring one = new M200LongestPalindromicSubstring();
		String str = "abcdzdcab";
		one.longestPalindrome(str);
	}
