 ...
 *
 * <p>Given a string s, return true if the s can be palindrome after deleting at most one character
 * from it.
 *
 * <p>Example 1:
 * <li>Input: s = "aba"
...
interface LeetCode680ValidPalindromeII {
  ...
  LeetCode680ValidPalindromeII Method =
      new LeetCode680ValidPalindromeII() {
        ...
        private boolean validPalindrome(String s, int start, int end, int mismatchChance) {
          if (mismatchChance < 0) {
            return false;
          }
          int left = start;
