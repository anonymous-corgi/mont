 ...
 * <p>Description
 *
 * <p>Given a sorted array (ascending order) and a target number, find the first index of this
 * number in O(logn) time complexity. If the target number does not exist in the array, return -1.
 */
interface LintCode014FirstPositionOfTarget {

  int binarySearch(int[] nums, int target);

  LintCode014FirstPositionOfTarget Method =
      new LintCode014FirstPositionOfTarget() {
  ...
  LintCode014FirstPositionOfTarget Recursive_Method =
      new LintCode014FirstPositionOfTarget() {
