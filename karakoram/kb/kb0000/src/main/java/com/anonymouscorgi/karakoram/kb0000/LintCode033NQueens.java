 ...
 * "Q...", "...Q", ".Q.." ] ]
 */
interface LintCode033NQueens {

  List<List<String>> solveNQueens(int n);

  LintCode033NQueens DFS = new LintCode033NQueens() {
  ...
  LintCode033NQueens BFS = new LintCode033NQueens() {
  ...
  LintCode033NQueens DFS2 = new LintCode033NQueens() {
