 ...
 *
 * <p>Description Given a list of numbers with duplicate numbers in it. Find all unique permutations
 * of it.
 */
interface LintCode016PermutationsII {
  ...
  LintCode016PermutationsII DFS =
      new LintCode016PermutationsII() {
