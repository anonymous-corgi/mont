 ...
 *
 * <p>Given the root of a binary tree, calculate the vertical order traversal of the binary tree.
 *
 * <p>For each node at position (row, col), its left and right children will be at positions (row +
 * 1, col - 1) and (row + 1, col + 1) respectively. The root of the tree is at (0, 0).
 *
 ...
 *
 * <p>Return the vertical order traversal of the binary tree.
 *
 * <p>Similar to {@link
 * com.anonymouscorgi.karakoram.kb0300.LeetCode314BinaryTreeVerticalOrderTraversal}
 */
interface LeetCode987VerticalOrderTraversalOfABinaryTree {

  List<List<Integer>> verticalTraversal(TreeNode root);

  LeetCode987VerticalOrderTraversalOfABinaryTree BFS =
      new LeetCode987VerticalOrderTraversalOfABinaryTree() {
        @Override
