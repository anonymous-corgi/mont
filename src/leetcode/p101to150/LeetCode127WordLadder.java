...
public class LeetCode127WordLadder {
    ...
    public LeetCode127WordLadder(String begin, String end, List<String> wordList, int expected) {
        this.begin = begin;
        this.end = end;
    ...
    private interface Method {
        ...
        default boolean isNextWord(String begin, String end) {
            int diff = 0;
    ...
    // DFS will easily stack overflow
    // Memorization is not practicable, because your previous pick might affect the following selection.
    ...
    private void test(String begin, String end, List<String> wordList, int expected) {
        int actual = getMethod().ladderLength(begin, end, wordList);
        assertThat(actual, is(expected));
    }

    @Test
    public void test() {
        test(begin, end, wordList, expected);
    }

    @Parameterized.Parameters
    public static Object[][] primeNumbers() {
        return new Object[][]{
                {"hit", "cog", new ArrayList<>(Arrays.asList("hot", "dot", "dog", "lot", "log", "cog")), 5},
                {"hit", "cog", new ArrayList<>(Arrays.asList("hot", "dot", "dog", "lot", "log")), 0},
